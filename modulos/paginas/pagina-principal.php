...
<?php $titulo  = "Bienvenido "; $mostrarMenu = true; include '../componentes/header.php';?>
        <div class="container-fluid" style="padding-right: 0;">
               <div class="row" style="margin-top:4rem;padding-right: 0; margin-right:0;">
                    ...
                    <div class="row" style="margin-left: 10rem !important; margin-right: 0;">
                              <?php for( $i = 0 ; $i < 20; $i++):?>
                                   <div class="coll col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                        <div class="card text-white mt-3">
                                                  <div class="row contenedor">
                                                       <div class="col-12">
                                                            <div class="btn-group pull-xs-right float-right" style="color:black;">
                                                       ...
                                                       <div class="card-img-overlay">
                                                            <p class="card-text mt-3 h3"><span class="badge badge-info">$400</span></p>
