...
<?php $titulo  = "Bienvenido "; $mostrarMenu = true; include '../componentes/header.php';?>
        <div class="container-fluid" style="padding-right: 0;">
               <div class="row" style="margin-top:4rem;padding-right: 0; margin-right:0;">
                    ...
                    <div class="row" style="margin-left: 10rem; margin-right: 0px;">
                              <?php for( $i = 0 ; $i < 20; $i++):?>
                                   <div class="coll col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                        <div class="card text-white mt-3">
                                                  <div class="row contenedor">
                                                       ...
                                                       <a href="<?php echo $raizP;?>modulos/paginas/informacion-prod.php"><img class="card-img-top ml-4" src="<?php echo $raizP;?>img/lemon.jpg" alt="Card image cap" style="width: 13rem; "></i></a>
                                                       <div class="card-img-overlay">
                                                            <p class="card-text mt-3"><span class="badge badge-info">$400</span></p>
                                                            <a href="<?php echo $raizP;?>modulos/paginas/informacion-prod.php" class="card-title h5">Card title</a>
