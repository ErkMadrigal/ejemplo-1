     ...
     <div class="container-fluid" style="padding-right: 0;">
               <div class="row" style="margin-top:4rem;padding-right: 0; margin-right:0;">
                   <?php $mostrarBusqueda = true; include 'modulos/componentes/busqueda.php';?>
                        <div class="col-4">
                        <?php for( $i = 0 ; $i < 20; $i++):?>
                            <div class="card mt-3" style="width: 47rem; height: 30rem;">
                                <img class="card-img-top" src="<?php echo $raizP;?>img/1234.png" alt="Card image cap" style="width: 47rem;">
                                <div class="card-body">
